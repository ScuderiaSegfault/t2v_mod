...
The firmware for the T2V module can be found at [https://github.com/ScuderiaSegfault/t2v_mod_fw](https://github.com/ScuderiaSegfault/t2v_mod_fw) and offers a wide range of configuration options.
...
[source,bash]
----
git clone https://github.com/ScuderiaSegfault/t2v_mod_fw.git && cd t2v_mod_fw
git checkout v0.1.0-alpha   # only possible after release
...
Save the configuration by pressing `S` and then `Q`.
